...
snowglobes.simulate(SNOwGLoBES_path, outfile, detector_input="all", detector_effects=False)
snowglobes.collate(SNOwGLoBES_path, outfile, detector_input="all", smearing=False, skip_plots=True)
